...
function UserxtdBuildRoute(&$query)
{
	...
	$com_menu = $menu->getItems( array('component'), array('com_userxtd') );
	...
	foreach( $com_menu as $menuitem ):
		...
		if( $menuitem->query['view'] == 'field' && $menuitem->query['id'] == $query['id'] ) {
			$item_menu = $menuitem ;
	...
	foreach( $com_menu as $menuitem ):
		...
		if( $menuitem->query['view'] == 'fields' && $menuitem->query['id'] == $query['catid'] ) {
			$item_menu = $menuitem ;
			//$segments = explode( '/', $item_menu->route);
	...
	foreach( $com_menu as $menuitem ):
		...
		if( $menuitem->query['view'] == 'fields' && $menuitem->query['id'] == $query['id'] ) {
			$cat_menu = $menuitem ;
...
function UserxtdParseRoute($segments)
{
	...
	if($segments[0] == 'api') {
		...
		include_once JPATH_ADMINISTRATOR.'/components/com_userxtd/includes/api/api.init.php' ;
