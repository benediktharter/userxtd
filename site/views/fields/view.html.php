 ...
 */
class UserxtdViewFields extends AKView
{
	/**
	...
	public function display($tpl = null)
	{
		...
		foreach( $this->items as &$item ):
			$item->link = JRoute::_("index.php?option=com_userxtd&view=field&id={$item->a_id}&alias={$item->a_alias}&catid={$item->a_catid}");
			...
			$results = $dispatcher->trigger('onContentAfterTitle', array('com_userxtd.field', &$item, &$item->params, 0));
			$item->event->afterDisplayTitle = trim(implode("\n", $results));

			$results = $dispatcher->trigger('onContentBeforeDisplay', array('com_userxtd.field', &$item, &$item->params, 0));
			$item->event->beforeDisplayContent = trim(implode("\n", $results));

			$results = $dispatcher->trigger('onContentAfterDisplay', array('com_userxtd.field', &$item, &$item->params, 0));
