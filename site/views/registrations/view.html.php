 ...
 */
class UserxtdViewRegistrations extends AKViewList
{
	/**
	...
	public function display($tpl = null)
	{
		...
		foreach( $this->items as &$item ):
			...
			// Link
			// =====================================================================================
			$item->link = new JURI("index.php?option=com_userxtd&view=registration&id={$item->a_id}") ;
			...
			$results = $dispatcher->trigger('onContentPrepare', array ('com_userxtd.registration', &$item, &$this->params, 0));

			$results = $dispatcher->trigger('onContentAfterTitle', array('com_userxtd.registration', &$item, &$item->params, 0));
			$item->event->afterDisplayTitle = trim(implode("\n", $results));

			$results = $dispatcher->trigger('onContentBeforeDisplay', array('com_userxtd.registration', &$item, &$item->params, 0));
			$item->event->beforeDisplayContent = trim(implode("\n", $results));

			$results = $dispatcher->trigger('onContentAfterDisplay', array('com_userxtd.registration', &$item, &$item->params, 0));
