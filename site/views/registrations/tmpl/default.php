...
UserxtdHelper::_('include.bootstrap', true);
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_userxtd&view=registrations'); ?>" method="post" name="adminForm" id="adminForm">
	
	<div id="userxtd-wrap" class="container-fluid registrations<?php echo $this->get('pageclass_sfx');?>">
		<div id="userxtd-wrap-inner">
			...
			<?php if ($this->params->get('show_description', 1) || $this->params->def('show_description_image', 1)) : ?>
				...
				<?php if ($this->params->get('show_description') && $this->category->description) : ?>
					<?php echo JHtml::_('content.prepare', $this->category->description, '', 'com_userxtd.category'); ?>
				<?php endif; ?>
				<div class="clr"></div>
				</div>
			<?php endif; ?>
