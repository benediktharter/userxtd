 ...
 * profile Table class
 */
class UserxtdTableProfile extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__userxtd_profiles', 'id', $db);
	}
    ...
    {
        $k = $this->_tbl_key;
        return 'com_userxtd.profile.' . (int) $this->$k;
    }
	...
	public function rebuild($parentId = null, $leftId = 0, $level = 0, $path = '')
	{
		if(!$parentId){
			...
			$table = JTable::getInstance('Profile', 'UserxtdTable') ;
			if( !$table->load(1) ){
				$k = $this->_tbl_key;
