 ...
 * user Table class
 */
class UserxtdTableUser extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__userxtd_users', 'id', $db);
	}
    ...
    {
        $k = $this->_tbl_key;
        return 'com_userxtd.user.' . (int) $this->$k;
    }
	...
	public function rebuild($parentId = null, $leftId = 0, $level = 0, $path = '')
	{
		if(!$parentId){
			...
			$table = JTable::getInstance('User', 'UserxtdTable') ;
			if( !$table->load(1) ){
				$k = $this->_tbl_key;
