...
class AKGrid
{
    ...
    {
        $this->columns = array_values($columns);        return $this;
    }    /**
    ...
    {
        $this->rows[$this->activeRow]['_row'] = $options;        return $this;
    }    /**
    ...
    {
        unset($this->rows[$id]);        if (in_array($id, $this->specialRows['header']))
        {
    ...
    {
        $output = array();
        $output[] = '<table' . $this->renderAttributes($this->getTableOptions()) . '>';        if (count($this->specialRows['header']))
        {
