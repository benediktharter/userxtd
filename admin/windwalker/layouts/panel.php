 ...
 */// no direct access
defined('_JEXEC') or die;if(JVERSION >= 3){
...
}$displayMenu    = count($list);$hide = JFactory::getApplication()->input->getBool('hidemainmenu');
if($hide){
    $displayMenu = false ;
}
?><?php if( JVERSION >= 3 ): ?>
...
<?php endif; ?><div id="ak-panel-wrap">
    <?php if( JVERSION >= 3 ): ?>
    ...
    <div id="toolbar-box" class="ak-toolbar m">
        ...
        </div>        <?php echo JToolBar::getInstance('toolbar')->render('toolbar') ; ?>        <div class="clr"></div>
    </div>
