 ...
 */// no direct access
defined('_JEXEC') or die;define('AKPATH_ROOT'        , dirname(__FILE__)) ;
...
define('AKPATH_LAYOUTS'     , AKPATH_ROOT.'/layouts') ;define('AKPATH_ASSETS'      , AKPATH_ROOT.'/assets') ;
define('AKPATH_TABLES'      , AKPATH_ROOT.'/tables') ;if(!defined('DS')){
    define('DS', DIRECTORY_SEPARATOR) ;
}// Include joomla api
// ========================================================================
jimport('joomla.html.toolbar');
jimport('joomla.filesystem.folder');
jimport('joomla.filesystem.file');include_once JPath::clean( AKPATH_BASE."/proxy.php" ) ;
include_once JPath::clean( AKPATH_HELPERS."/akhelper.php" ) ;// Set Default helper prefix for AKProxy
AKHelper::setPrefix('AKHelper') ;
AKHelper::addIncludePath(AKPATH_HELPERS) ;function akLoader($uri, $option = null){
    return AKHelper::_('loader.import', $uri, $option) ;
}include_once JPath::clean( AKPATH_ADMIN."/toolbar.php" ) ;
include_once JPath::clean( AKPATH_BASE."/text.php" ) ;// Load Language
