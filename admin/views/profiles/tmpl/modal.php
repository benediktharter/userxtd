...
<form action="<?php echo $uri = JFactory::getURI()->toString() ; ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist table table-striped">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canEdit	= $user->authorise('core.edit',			'com_userxtd.profile.'.$item->a_id);
			$canCheckin	= $user->authorise('core.manage',		'com_userxtd.profile.'.$item->a_id) || $item->a_checked_out == $userId || $item->a_checked_out == 0;;
			$canChange	= $user->authorise('core.edit.state',	'com_userxtd.profile.'.$item->a_id) && $canCheckin;
			$canEditOwn = $user->authorise('core.edit.own',		'com_userxtd.profile.'.$item->a_id) && $item->created_user_id == $userId;
