...
<form action="<?php echo JRoute::_( JFactory::getURI()->toString() ); ?>" method="post" name="adminForm" id="profile-form" class="form-validate">
	...
	<?php echo $tabs ? UserxtdHelper::_('panel.startTabs', 'profileTab', array( 'active' => $this->fields[0] ) ) : null ; ?>
		...
		<?php foreach( $this->fields as $key => $group ): 
				...
				echo $tabs ? UserxtdHelper::_('panel.addPanel' , 'profileTab', JText::_('COM_USERXTD_EDIT_FIELDS_'.$group) , $group ) : null ;
		...
		?>
			...
			<?php echo $tabs ? UserxtdHelper::_('panel.endPanel' , 'profileTab' , $group ) : null ; ?>
