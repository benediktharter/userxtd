...
foreach( $this->items as $k => $item ):
	...
	// =================================================================================
		...
		if ($item->get('a_checked_out'))
			$content .= JHtml::_('jgrid.checkedout', $i, $item->get('a_checked_out'), $item->get('a_checked_out_time'), 'fields.', $canCheckin);
		
		if ($canEdit || $canEditOwn) 
			$content .= JHtml::link(JRoute::_('index.php?option=com_userxtd&task=field.edit&id='.$item->a_id), $item->get('a_title')) ;
		
		
		$content .= '<div class="small">'.JText::sprintf('JGLOBAL_LIST_ALIAS', $this->escape( $item->get('a_alias') )).'</div></div>' ;
		
		JHtml::_('dropdown.edit', $item->id, 'fields.');
	...
	// =================================================================================
		...
		$content = JHtml::_('jgrid.published', $item->a_published, $i, 'fields.', $canChange, 'cb', $item->a_publish_up, $item->a_publish_down);
