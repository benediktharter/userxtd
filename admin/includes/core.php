...
if( !defined('AKPATH_ROOT') ) {
	$inner_ww_path 	= JPATH_ADMINISTRATOR . "/components/com_userxtd/windwalker" ;
...
include_once JPath::clean( JPATH_ADMINISTRATOR . "/components/com_userxtd/helpers/userxtd.php" ) ;
include_once JPath::clean( JPATH_ADMINISTRATOR . "/components/com_userxtd/includes/loader.php" ) ;
